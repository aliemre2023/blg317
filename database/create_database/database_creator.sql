...
ATTACH DATABASE '/path/to/nba.sqlite' AS nba_original;
ATTACH DATABASE '/path/to/players.sqlite' AS player_images;
-----------------------------------------------------------------
-- admins
-----------------------------------------------------------------
...
VALUES ('Afghanistan', 'AF', 'https://www.worldometers.info/img/flags/small/tn_af-flag.gif'),
...
INSERT INTO teams (team_id, abbreviation, nickname, year_founded, owner, general_manager, headcoach,
                   dleague_affiliation, facebook, instagram, twitter, city_id, arena_id)
SELECT
    team_id,
    abbreviation,
    nickname,
...
INSERT INTO quotes (player_id, quote) VALUES
    (2738, "I like stick deodorant. I'm not a huge fan of spritz."),
...
-----------------------------------------------------------------
-- Rename the existing table
ALTER TABLE countries RENAME TO countries_v1;
...
-----------------------------------------------------------------
-- Rename the existing table
ALTER TABLE states RENAME TO states_v1;
...
-----------------------------------------------------------------
-- Rename the existing table
ALTER TABLE cities RENAME TO cities_v1;
...
-----------------------------------------------------------------
-- Rename the existing table
ALTER TABLE arenas RENAME TO arenas_v1;
...
FROM
    arenas_v1
WHERE
    TRIM(name) != '' AND LENGTH(name) <= 100;

-- Drop the old table
DROP TABLE arenas_v1;
...
-- Insert data from the old table to the new table, handling potential violations
INSERT INTO teams (team_id, abbreviation, nickname, name, year_founded, city_id, arena_id, owner, general_manager,
                   headcoach, dleague_affiliation, facebook, instagram, twitter, logo_url)
SELECT
    team_id,
    abbreviation,
    nickname,
...
-----------------------------------------------------------------
-- Rename the existing table
ALTER TABLE officials RENAME TO officials_v1;
...
-----------------------------------------------------------------
-- Rename the existing table
ALTER TABLE players RENAME TO players_v1;
...
-----------------------------------------------------------------
-- Rename the existing table
ALTER TABLE player_infos RENAME TO player_infos_v1;
...
-----------------------------------------------------------------
-- Rename the existing table
ALTER TABLE drafts RENAME TO drafts_v1;
...
-----------------------------------------------------------------
-- Rename the existing table
ALTER TABLE game_stats RENAME TO game_stats_v1;
